...
aliases: ["医械注册枢纽","注册工程师资料库","RA资料库"]
description: "医疗器械注册工程师的随身资料库：中/美/欧/日及东南亚·拉美全球注册路径与分类，UDI、STED、生物相容性、GMP、上市后监管等20个专题枢纽，按全生命周期7阶段覆盖，官方直达链接一站备齐。"
...
| 阶段 | 枢纽 | 解决什么 |
|---|---|---|
| 立项 | 分类界定 / 注册检验申报 | 产品归哪类、要不要检 |
| 准备 | 技术文件 STED / 生物相容性 / 灭菌 | 文件与安全性证据 |
| 质量 | GMP / 设计开发 / 软件·人因 | 体系与软件合规 |
| 申报 | NMPA / FDA 510(k) / MDR CE / PMDA | 各市场路径 |
| 标识 | UDI / 标签 IFU | 上市标识与说明书 |
| 上市后 | 临床评价 / 审评核查 / 风险 / 售后 / 市场准入 | 拿证后全周期 |

> 完整 20 枢纽 + 119 条官方链接见 `references/` 目录，已浏览器级核验可达。

## 常见问答（FAQ）

**Q：中国 / 美国 / 欧盟注册路径怎么选？**
A：看目标市场。国内销售走 NMPA（二类备案 / 三类许可）；出口美国走 FDA 510(k)（实质等同）或 PMA（高风险）；出口欧盟走 MDR CE（公告机构评审）。多市场并行需分别备技术文件，STED 可作共性底座。

**Q：UDI 什么时候做？**
A：上市前必须。按法规分步实施（器械标识 + 生产标识 + 数据库备案）。详见「UDI」枢纽。

**Q：临床评价必须做试验吗？**
A：不一定。可用同品种比对（临床评价报告）替代临床试验，除非无同类可比。详见「临床评价」枢纽。

## 全球注册 30秒导航

1. **定市场**：国内(NMPA) / 美(FDA) / 欧(MDR) / 日(PMDA) / 东南亚·拉美
2. **定路径**：备案 or 许可 or 510(k) or CE
3. **备文件**：STED + 生物相容 + GMP + 临床评价
4. **标标识**：UDI + 标签 IFU
5. **上市后**：监测 + 变更 + 年报

> 官网 https://medxpert.cn 有公开橱窗版（L0 层，精选 20 枢纽公开内容，免费开放）。
